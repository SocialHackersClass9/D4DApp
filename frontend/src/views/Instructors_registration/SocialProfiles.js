    ...
    switch (name) {
      ...
      case "last_name":
        formErrors.last_name =
          value.length == 0 ? "Last Name cannot be empty !" : ""
        break;

      case "gender":
        formErrors.gender =
          value.length == 0 ? "Gender cannot be empty !" : ""
        break;

      case "year_of_birth":

        formErrors.year_of_birth =
          value.length == 0 ? "Year of birth cannot be empty !" : new Date().getFullYear() - value < 3 ? "Enter your year of birth !" : new Date().getFullYear() - value > 150 ? "Enter your year of birth !" : ""
        break;

      case "sport":
        formErrors.sport =
          value.length == 0 ? "Sports cannot be empty !" : value == null ? "Sports cannot be empty !" : ""
        break;

      case "location":
        formErrors.location =
          value.length == 0 ? "Location cannot be empty !" : value == null ? "Location cannot be empty !" : ""
        break;
