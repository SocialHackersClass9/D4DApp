...
function SportParalymics() {
  ...
  const extraContent1 = (
    <div>
      <p className="extra-content text-justify">
        ...
        αναπηρία, με απώλεια λειτουργικότητας σε ένα ή και τα δύο κάτω άκρα.
  ...
  const extraContent11 = (
    <div>
      <p className="extra-content text-justify">
        <br />
        Η Πετοσφαίριση καθιστών αθλητών έκανε την εμφάνισή της το 1956
  ...
  const extraContent15 = (
    <div>
      <p className="extra-content text-justify">
        ...
        αθλητές και είναι ιδιαίτερα ευκίνητα. Απαιτούν συνεχή υποστήριξη και
        επισκευή κατά τη διάρκεια του αγώνα καθώς καταπονούνται από συνεχείς συγκρούσεις.
        Ο αγώνας απότελείται από τέσσερις περιόδους των  οκτώ λεπτών με διακοπή ενδιάμεσα.
        Κάθε ομάδα αποτελείται
  ...
  const extraContent16 = (
    <div>
      <p className="extra-content text-justify">
        ...
        παγκοσμίως. Απαιτεί καλή τεχνική κατάρτιση καθώς και τη δυνατότητα
  ...
  const extraContent19 = (
    <div>
      <p className="extra-content text-justify">
        ...
        δυνατότητα στους αθλητές να ασκήσουν τη δεξιότητα, την ακρίβεια, τη
  ...
  const extraContent21 = (
    <div>
      <p className="extra-content text-justify">
        <br />
        Το τρίαθλο κάνει το Παραολυμπιακό του ντεμπούτο στους Παραολυμπιακούς
  ...
  const extraContent22 = (
    <div>
      <p className="extra-content text-justify">
        <br />
        Το κανόε εντάχθηκε στο Παραολυμπιακό πρόγραμμα για πρώτη φορά
        στους Παραολυμπιακούς Αγώνες του Ρίο ντε Ζανέιρο το 2016.
        ...
        αλλά καθώς αναπτύσσεται το άθλημα μπορεί να συμπεριληφθούν
  ...
  const extraContent23 = (
    <div>
      <p className="extra-content text-justify">
        ...
        σειρά πύλες στρίβοντας στα κατάλληλα σημεία γεγονός που κάνει ακόμα πιο δύσκολή την κατάβαση.
      </p>
    ...
    <div>
      <p className="extra-content text-justify">
        ...
        Και στα δύο αγωνίσματα του αθλήματος του διάθλου δηλαδή και στο σκι αντοχής και στη σκοποβολή
         ...
         χωρίς αναπηρία αλλά αγωνίζονται μαζί με έναν οδηγό- συναθλητή, στη σκοποβολή χρησιμοποιούν
      ...
      <div className="row1">
        ...
        >
          ...
          <p className="text-justify">
            ...
            Στόουκ Mάντεβιλ στην Αγγλία. Την ημέρα της τελετής έναρξης για τους
            Ολυμπιακούς Αγώνες του 1948 στο Λονδίνο, ξεκίνησαν και
            θεσμοθετήθηκαν οι αγώνες του Στόουκ Mάντεβιλ και πραγματοποιήθηκε η
